      ...
      <header class="blog-header py-3">
        <div class="row flex-nowrap justify-content-between align-items-center">
          <div class="col-4 pt-1">
             ...
             <a class="btn btn-sm btn-outline-success active" style="font-size:20px;" href="#">
             BIENVENIDO 
            <?php 
          ...
          <div class="col-4 d-flex justify-content-end align-items-center">
            ...
            <a class="btn btn-sm btn-outline-danger" style="font-size:20px;" href="closesesion.php">Cerrrar Sesion</a>
          </div>
        </div>
      </header>
