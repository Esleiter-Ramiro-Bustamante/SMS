...
<form  action="sms.php" method="post" class="form-horizontal">

  <fieldset>
      <legend><center><h2>Enviar Mensaje de Texto</h2></center></legend>
      
      
        <div class="form-group">
    <label for="usuario">Telefono:</label>
    <input required type="text" class="form-control bg-primary text-white"   name="num" value="<?php echo $tel; ?>" >
 	   </div>
        <div class="form-group">
    ...
    <input required type="text" class="form-control"  name="msj" placeholder="Mensaje" >
 	   </div>
      <br>
